        ...
        <section>
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="mt-3">
                <label className="block text-xs font-medium text-gray-500 mb-1">
                  URL Parameters from Fields
                </label>
                <p className="text-xs text-gray-400 mb-2">
                  Use {'{FieldName}'} placeholders to inject field values into the endpoint path or query string.
                  Click a field below to insert its placeholder into the endpoint.
                </p>
                {columns.length === 0 ? (
