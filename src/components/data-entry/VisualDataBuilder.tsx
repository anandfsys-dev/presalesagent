          ...
          <div key={col.name}>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                title={!connectionId ? 'No connection selected' : !col.externalSobject ? 'No Salesforce object configured' : `Select from ${col.externalSobject}`}
              >
            ...
            <p className="text-xs text-gray-500 mt-1">
              From: {col.externalSobject || 'Not configured'}
            </p>
          </div>
        );
      }
