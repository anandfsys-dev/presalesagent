...
export default function DashboardPage() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      <PageHeader
        title="Dashboard"
        subtitle="Revenue Cloud Configuration Tool"
        user={user}
      />
              ...
              <CardContent>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-semibold text-gray-900">{connectionsCount}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-semibold text-gray-900">{recentDeployments.length}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-semibold text-gray-900">
                      {recentDeployments.filter(d => d.status === 'completed').length}
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-2 border-dashed border-gray-300 bg-gray-50">
              <CardContent className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6 max-w-md mx-auto">
                  Connect your first Salesforce org to begin configuring Revenue Cloud Advanced products.
                </p>
                <Link
                  href="/dashboard/connections"
